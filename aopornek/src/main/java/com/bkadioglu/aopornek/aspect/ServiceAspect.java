package com.bkadioglu.aopornek.aspect;
...
public class ServiceAspect {
    ...
    @Before("execution(* com.bkadioglu.aopornek.service.MessageService.mesajVer(..))")
    ...
    @After("execution(* com.bkadioglu.aopornek.service.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.bkadioglu.aopornek.service.MessageService.mesajVer(..))",
            returning="retVal")
